...
script="neurons/miner/main.py"
autoRunLoc=$(readlink -f "$0")
proc_name="image_alchemy_miner" 
args=()
...
if [ "$?" -eq 1 ]; then
    while true; do
        ...
        if [ -d "./.git" ]; then
            ...
            latest_version=$(check_variable_value_on_github "Supreme-Emperor-Wang/ImageAlchemy" "template/__init__.py" "__version__ ")
